                    ...
                    <>
                      ...
                      {kycCountry === "US" ? (
                        <div className={`p-4 sm:p-5 rounded-2xl border transition-all duration-200 relative overflow-hidden ${isLightText
                          ...
                          {/* Legal Compliance Explanatory Note */}
                          ...
                          {(() => {
                            ...
                            return (
                              <div>
                                {/* Unified Executive High-Contrast Auto-Formatting Input Box */}
                                <div className="relative flex items-center w-full">
                                  <div className={`absolute left-3.5 flex items-center pointer-events-none ${isLightText ? 'text-amber-400' : 'text-amber-700'}`}>
                                ...
                                {/* Security Badges & Live Status Footer */}
                                <div className="mt-3 flex flex-wrap items-center justify-between gap-1 text-[10.5px]">
                                  <div>
                                    {isComplete ? (
                                      <span className="text-emerald-400 font-bold flex items-center gap-1">
                                        ...
                                        ✓ 9-Digit SSN Encrypted & Verified
                                      </span>
                                    ) : totalDigits > 0 ? (
                                      <span className="text-amber-400 font-bold flex items-center gap-1">
                                        ⚠️ {9 - totalDigits} more {9 - totalDigits === 1 ? 'digit' : 'digits'} required
                                      </span>
                                    ) : (
                                      <span className={isLightText ? 'text-white/45' : 'text-slate-400'}>Enter your 9-digit SSN</span>
                                    )}
                                  </div>

                                  <div className={`flex items-center gap-1.5 font-semibold ${isLightText ? 'text-amber-300/80' : 'text-amber-900/80'}`}>
                                    <span>🛡️ Federal CIP Standard</span>
                                    <span>•</span>
