...
export function aggregateAnalyticsReceipts(receipts: Record<string, any>[], timeZone: string) {
  ...
  return {
    ...
    stats: {
      ...
      dedupedTotalAbandoned: dedup.dedupedTotalAbandoned,
      trueIntegrationRate: dedup.completionRate, trueProcessRate: dedup.resolvedSuccessRate,
      completionRate: dedup.completionRate, abandonmentRate: dedup.abandonmentRate, resolvedSuccessRate: dedup.resolvedSuccessRate,
