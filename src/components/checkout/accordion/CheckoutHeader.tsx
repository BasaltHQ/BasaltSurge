  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between px-1 pb-1 gap-2 flex-wrap">
        ...
        <div className={`text-[10px] font-semibold flex items-center gap-1.5 shrink-0 ${isLightText ? "text-white/60" : "text-black/60"}`}>
      ...
      <div className={`flex items-center justify-between px-3 py-2 rounded-xl border gap-2 flex-wrap ${isLightText ? "bg-white/[0.03] border-white/10" : "bg-black/[0.03] border-black/10"}`}>
