      ...
      {!element && (
        <div className="w-full space-y-3 py-2 animate-in fade-in duration-200">
          {isStalled ? (
            ...
            <div className="p-3.5 rounded-xl bg-amber-500/10 border border-amber-500/30 text-amber-300 text-xs space-y-2 text-left">
              ...
              {onTimeoutRetry && (
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg bg-amber-500/20 hover:bg-amber-500/30 border border-amber-500/40 text-amber-200 text-[11px] font-bold transition-all flex items-center gap-1.5 cursor-pointer"
                >
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold opacity-90">{loadingMessage}</span>
                </div>
